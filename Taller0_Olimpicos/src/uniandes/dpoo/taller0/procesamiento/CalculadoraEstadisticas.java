...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pa�s del atleta indicado por nombre
	 * 
	 * @param nombreAtleta El nombre del atleta que se está buscando
	 * @return El pa�s del atleta dado o null si no se encuentra.
	 */
	public String buscarPaisAtleta(String pNombre)
	{
		
	Atleta elAtleta = buscarAtleta(pNombre);
