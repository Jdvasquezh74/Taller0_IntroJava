...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pa�s al que representa un atleta");
	...
	/**
	 * Este m�todo sirve pide al usuario el nombre de un atleta para luego
	 * retornar el pa�s al cual representa el atleta pedido.
	 * 
	 * @param pNombre El nombre del atleta.
	 * @return El pa�s al cual representa el atleta.
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Pa�s al que representa un atleta" + "\n");

		String pNombre = input("Por favor ingrese el nombre de un atleta");
		
		String paisAtleta = calculadora.buscarPaisAtleta(pNombre);
		
		if (paisAtleta != null)
		{
		
			System.out.println("\n" + "El/la atleta " + pNombre + " representa al pa�s de " + paisAtleta + ".\n");
		}
		else
		{
			System.out.println("\n" + "ERROR: Por favor verifique el nombre.\nNo se ha encontrado al atleta." + "\n");
		}
	}
